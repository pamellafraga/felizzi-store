...
export function CollectionBlock({ collection, featured = false }: CollectionBlockProps) {
  return (
    <article className={cn("group relative overflow-hidden bg-sand", featured ? "min-h-[70vh]" : "min-h-[52vh]")}>
      <Image
      ...
      <div className="absolute inset-x-0 bottom-0 p-8 sm:p-10">
        ...
        <h2 className="mt-3 font-display text-5xl font-light text-ivory sm:text-6xl">{collection.name}</h2>
