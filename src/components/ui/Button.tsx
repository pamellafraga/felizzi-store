...
export function Button({ href, children, variant = "solid", className, external }: ButtonProps) {
  ...
  const classes = cn(
    "inline-flex min-h-11 items-center justify-center gap-3 px-6 py-3.5 text-[11px] font-medium uppercase tracking-[0.18em] transition-colors duration-500 sm:px-7 sm:tracking-[0.22em]",
