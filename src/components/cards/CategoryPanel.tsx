...
export function CategoryPanel({ collection }: { collection: Collection }) {
  return (
    <Link href={`/categoria/${collection.slug}`} className="group relative block min-h-[48vh] overflow-hidden bg-sand md:min-h-[58vh]">
      <Image
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
        <h3 className="font-display text-4xl font-light tracking-tight text-ivory sm:text-6xl">{collection.name}</h3>
